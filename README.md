...
yoyo.org | Peter Lowe | Blocking with ad server and tracking server hostnames | [LINK](https://pgl.yoyo.org/adservers/) | [RAW](https://pgl.yoyo.org/adservers/serverlist.php?hostformat=hosts&mimetype=plaintext&useip=0.0.0.0) | MCRAE GENERAL PUBLIC LICENSE (version 4.r53) | 
ZeuS Tracker | abuse.ch | This blocklist contains all domain names associated with ZeuS C&Cs | [LINK](https://zeustracker.abuse.ch/) | [RAW](https://zeustracker.abuse.ch/blocklist.php?download=domainblocklist) | All Rights Reserved | [SOURCE](https://block.energized.pro/assets/sources/filter/zeustracker.abuse.ch.txt) |
